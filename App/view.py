...
def filtrar_lista(lista_dics,lista_columnas):
    lista_filt = []
...
def print_req_6(control):
    ...
    tabulate_respuesta = tabulate(respuesta_filtrada, headers='keys', tablefmt= "grid", maxcolwidths =15)
    ...
    while i< tamanio_lista:
        ...
        subsector_mayor_filt = filtrar_dic_con_por_llaves(subsector_mayor,['Código subsector económico',
                                          ...
                                          'Total costos y gastos','Total saldo a pagar','Total saldo a favor'])
        subsect_mayor_tab = tabulate([subsector_mayor_filt], headers='keys', tablefmt= "grid", maxcolwidths =15)
        ...
        actividad_menos_subsector_mayor_filt = filtrar_dic_con_por_llaves(actividad_menos_subsector_mayor,['Código actividad económica',
                                              'Nombre actividad económica','Total ingresos netos',
                                          'Total costos y gastos','Total saldo a pagar','Total saldo a favor'])
        tab_mayor_mayor = tabulate([actividad_mas_subsector_mayor_filt], headers='keys', tablefmt= "grid", maxcolwidths =15)
        tab_mayor_menor = tabulate([actividad_menos_subsector_mayor_filt], headers='keys', tablefmt= "grid", maxcolwidths =15)
        ...
        subsector_menor_filt = filtrar_dic_con_por_llaves(subsector_menor,['Código subsector económico',
                                              'Nombre subsector económico','Total ingresos netos',
                                          'Total costos y gastos','Total saldo a pagar','Total saldo a favor'])
        subsect_menor_tab = tabulate([subsector_menor_filt], headers='keys', tablefmt= "grid", maxcolwidths =15)
        ...
        tab_menor_mayor = tabulate([actividad_mas_subsector_menor_filt], headers='keys', tablefmt= "grid", maxcolwidths =15)
        tab_menor_menor = tabulate([actividad_menos_subsector_menor_filt], headers='keys', tablefmt= "grid", maxcolwidths =15)
...
def print_req_7(control):
    ...
    fin = filtrar_lista(respuesta[0], heads)
